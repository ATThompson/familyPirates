          ...
          <div key={joueur.id} className="flex">
            <div className="flex w-full gap-0.5">
              ...
              <div className="flex ml-auto self-center">
                <button onClick={e => modifierNbPieces(e, joueur.id, -1)} className='text-[#af1004]'>－</button>
                💰
                <button onClick={e => modifierNbPieces(e, joueur.id, 1)} className='text-[#019701]'>＋</button>
              </div>
            </div>
          </div>
        ))}
