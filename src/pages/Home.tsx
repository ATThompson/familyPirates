...
const Home = () => {
  ...
  const content = [
    ...
    "Chaque participation vous coûtera quelques pièces… Saurez-vous en gagner plus que vous n’en perdez ? Retrouvez les détails des épreuves dans la section “Règles des jeux” !",
